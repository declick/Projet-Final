            ...
            <nav className="nav_checkbox">
                ...
                <div className="container_home">
                    <div>
                        ...
                        <NavLink to="/" aria-label="page"><img className="logo_blanc" src="../image/blanc.png" alt="Logo MyLittleLashes"></img></NavLink>
                    </div>
                ...
                <ul className="content_nav">
                    ...
                    {state.connexion && (
                        <React.Fragment>
                            ...
                            <li> <NavLink className="" to="/Profil"><RiUserSettingsFill className="icon_react" aria-label="profil" /></NavLink> / <NavLink to="/Logout"> <RiLogoutBoxRLine className="icon_react" aria-label="déconnexion" /></NavLink></li>
                        </React.Fragment>
                    )}{state.admin && (
                        <React.Fragment>
